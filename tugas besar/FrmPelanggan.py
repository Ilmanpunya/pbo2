...
class FrmPelanggan:
    ...
    def aturKomponen(self):
        ...
        # define columns
        columns = ('id','id_pelanggan','nama','umur','waktu')
        ...
        self.tree.column('umur', width="30")
    ...
    def onReload(self, event=None):
        ...
        for i, d in enumerate(parsed_data):
            self.tree.insert("", i, text="Item {}".format(i), values=(d["id"],d["id_pelanggan"],d["nama"],d["umur"],d["waktu"]))
